...
class TCPNULLProbing(BaseAttack.BaseAttack):
    ...
    def __init__(self):
        """
        Creates a new instance of the TCP NULL Probing.
        This attack injects TCP NULL-requests and respective responses into the output pcap file.
        """
        # Initialize attack
        super(TCPNULLProbing, self).__init__("TCPNULLProbing", "Injects a nmap 'NULL scan'",
                                             "Scanning/Probing")
