...
class DrupalScan(BaseAttack.BaseAttack):
    ...
    template_scan_pcap_path = Util.RESOURCE_DIR + "drupal_version_and_plugins_enumeration_scan.pcap"

    """
    Creates a new instance of the Drupal Scan attack 
    This attacks scans for drupal versions and popular plugins installed on the CMS. 
    """
    def __init__(self):
        # Initialize attack
    ...
    def generate_attack_packets(self):
        ...
        for self.pkt_num, pkt in enumerate(exploit_raw_packets):
            ...
            new_pkt.time = timestamp_next_pkt + 0
