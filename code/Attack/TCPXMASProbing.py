...
class TCPXMASProbing(BaseAttack.BaseAttack):
    ...
    def __init__(self):
        """
        Creates a new instance of the TCP XMAS Probing.
        This attack injects TCP XMAS-requests and respective responses into the output pcap file.
        """
        # Initialize attack
        super(TCPXMASProbing, self).__init__("TCPXMASProbing", "Injects a nmap 'XMAS scan'",
                                             "Scanning/Probing")
    ...
    def generate_attack_packets(self):
        ...
        for ip in ip_destination:
            ...
            for dport in dest_ports:
                ...
                request_tcp = inet.TCP(sport=sport, dport=dport, seq=src_starting_seq, window=source_win_value, flags='FPU')
