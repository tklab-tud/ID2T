...
class TCPFINProbing(BaseAttack.BaseAttack):
    ...
    def __init__(self):
        """
        Creates a new instance of the TCP FIN Probing.
        This attack injects TCP FIN-requests and respective responses into the output pcap file.
        """
        # Initialize attack
        super(TCPFINProbing, self).__init__("TCPFINProbing", "Injects a nmap 'FIN scan'",
                                             "Scanning/Probing")
    ...
    def generate_attack_packets(self):
        ...
        for ip in ip_destination:
            ...
            for dport in dest_ports:
                ...
                request_tcp = inet.TCP(sport=sport, dport=dport, seq=src_starting_seq, window=source_win_value, flags='F')
