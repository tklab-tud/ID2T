...
class WordpressScan(BaseAttack.BaseAttack):
    PORT_DESTINATION = 'port.dst'
    ATTACKER_IP = '172.18.0.1' 
    VICTIM_IP = '172.18.0.5'
    MYSQL_DB_IP = '172.18.0.2'
    template_scan_pcap_path = Util.RESOURCE_DIR + "WordpressScan.pcap"

    MY_SQL_PORT = 3306

    """
    Creates a new instance of the Wordpress Scan
    """
    def __init__(self):
        # Initialize attack
        super(WordpressScan, self).__init__("WordpressScanAttack", "Injects a Wordpress v5.3 Scan'",
                                             "Scanning/Probing")
        self.pkt_num = 0
